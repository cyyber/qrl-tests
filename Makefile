.PHONY: lint network-preflight network-start network-stop e2e e2e-run soak soak-run
...
soak:
	go run ./cmd/qrltest soak --existing

soak-run: network-preflight
	go run ./cmd/qrltest soak
